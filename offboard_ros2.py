...
class OffboardPolylineFollower(Node):
    def __init__(self):
        ...
        self.waypoints = [
            [-1.67, -1.01, 1.00, 0.0],
            [-0.59, 0.0165, 1.33, 45.0],
            [1.553, -0.7077, 1.8818, 135.0],
            [1.865, 1.524, 1.4856, -135.0],
            [-0.92, 1.683, 2.120, -135.0],
            [-1.78, -0.44, 1.78, 0.0],
        ]
        ...
        # TAKEOFF -> FOLLOW -> FINISH_HOLD -> LAND_OFFBOARD -> LAND_REQUEST -> LANDING_CONFIRM -> DISARM_REQUEST -> DONE
